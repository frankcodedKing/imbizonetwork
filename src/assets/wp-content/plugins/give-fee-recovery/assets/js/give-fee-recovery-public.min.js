(() => {
    ...
    r.n = e => {
        ...
        function i(e, r) {
            ...
            var i = give_fee_recovery_object.give_fee_zero_based_currency,
                o = JSON.parse(i);
        ...
        jQuery.noConflict(), o = jQuery, window.Give_Fee_Recovery = {
            ...
            give_fee_update: function(e, a, r, c) {
                ...
                if (_) {
                    ...
                    var M = give_fee_recovery_object.give_fee_zero_based_currency,
                        A = JSON.parse(M),
            ...
            o("body").on("change", ".give_fee_mode_checkbox", (function() {
                ...
                void 0 === n && (n = form.attr("data-gateway")), Give_Fee_Recovery.give_fee_update(a, !0, t, n)
